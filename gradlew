...
<root>
  <item name="com.google.android.material.textfield.DropdownMenuEndIconDelegate boolean isBoxBackgroundModeSupported(int) 0">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{com.google.android.material.textfield.TextInputLayout.BOX_BACKGROUND_NONE, com.google.android.material.textfield.TextInputLayout.BOX_BACKGROUND_FILLED, com.google.android.material.textfield.TextInputLayout.BOX_BACKGROUND_OUTLINE}" />
    </annotation>
  </item>
  ...
  <item name="com.google.android.material.textfield.IndicatorViewController android.widget.TextView getCaptionViewFromDisplayState(int) 0">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{com.google.android.material.textfield.IndicatorViewController.CAPTION_STATE_NONE, com.google.android.material.textfield.IndicatorViewController.CAPTION_STATE_ERROR, com.google.android.material.textfield.IndicatorViewController.CAPTION_STATE_HELPER_TEXT}" />
    </annotation>
  </item>
  ...
  <item name="com.google.android.material.textfield.IndicatorViewController boolean isCaptionView(int) 0">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{com.google.android.material.textfield.IndicatorViewController.COUNTER_INDEX, com.google.android.material.textfield.IndicatorViewController.ERROR_INDEX, com.google.android.material.textfield.IndicatorViewController.HELPER_INDEX}" />
    </annotation>
  </item>
